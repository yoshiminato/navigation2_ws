...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(tb4_launcher_dir, 'params', 'nav2_params.yaml'),
    ...
    # Note: The TurtleBot4 URDF uses 'tf' topic without leading slash, but the bridge 
    # expects '/tf'. This is handled by the spawn_tb4.launch.py file.
    ...
    logging.info(f"launch_dir: {launch_dir}")
